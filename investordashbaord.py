...
def main():
    ...
    with tab1:
        ...
        if "default_variable_roles" not in st.session_state:
            st.session_state["default_variable_roles"] = [
                {"name": "Onboarding Specialist", "headcount": 0,
                    "base_salary": 3000, "annual_raise": 0.05, "capacity": 160},
                {"name": "Technical Support Programmers", "headcount": 0,
                    "base_salary": 3500, "annual_raise": 0.05, "capacity": 160},
            ]
        ...
        hardware_cost_per_employee = st.number_input(
            "Hardware cost per employee (monthly R)", 0.0, 1e12, 5000.0, step=500.0)
        ...
        if not cfg:
            ...
            if not df_final.empty:
                ...
                for i in range(len(df_final)):
                    ...
                    total_whitelabel = (
                        basic_wf * basic_whitelabel_buyers) + (advanced_wf * advanced_whitelabel_buyers)
            ...
            if df_final.empty:
                ...
                plan_columns = [
                    ...
                    if col.startswith("Revenue_") and col not in ["Revenue_Total", "Revenue_SetupFees", "Revenue_TopUp", "Revenue_Whitelabel"]
                ]
